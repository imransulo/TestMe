		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String query1 = "Select * from TeacherLogIn where username = '"+user.getText()+"' and password = '"+pass.getText()+"'";
					ResultSet rs = s.executeQuery(query1);
					if(rs.next()) { new TeacherCategoryChoose().frame.setVisible(true); frame.dispose(); }
